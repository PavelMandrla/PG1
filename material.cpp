...
bool Material::isEmittingLight() {
	return this->emission.x != 0.0f || this->emission.y != 0.0f || this->emission.z != 0.0f;
}

Color4f Material::getEmittedLight() {
	return Color4f{this->emission.x, this->emission.y, this->emission.z, 1.0f};
}
